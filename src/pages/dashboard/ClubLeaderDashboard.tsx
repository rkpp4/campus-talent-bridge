...
import { Users, Calendar, Plus, UserPlus, CheckCircle } from "lucide-react";
    ...
    return (
      <div className="flex flex-col items-center justify-center py-16">
        ...
        <p className="text-muted-foreground text-center max-w-md">
          You haven't been assigned to any club yet. Please contact the administrator to get assigned as a club leader.
        </p>
      </div>
    );
  }
